...
class PendingAiBubble extends StatefulWidget {
  const PendingAiBubble({super.key});

  @override
  State<PendingAiBubble> createState() => _PendingAiBubbleState();
}

class _PendingAiBubbleState extends State<PendingAiBubble>
